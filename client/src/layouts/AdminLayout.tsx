...
const navItems = [
  ...
  { path: "/admin/absent-members", label: "الأعضاء الغائبون", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M9 9h.01"/><path d="M15 9h.01"/><path d="M8 14a4 4 0 0 1 8 0"/><circle cx="12" cy="12" r="10"/></svg> },
