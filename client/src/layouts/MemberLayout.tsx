...
const navItems = [
  ...
  {
    path: "/member/personal-records",
    label: "الأرقام الشخصية",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: "hsl(0 0% 5%)" }} dir="rtl">
      ...
      <div className="flex flex-col flex-1 overflow-hidden md:mr-0">
        ...
        <main ref={pullRef} className="flex-1 overflow-y-auto pb-16 md:pb-0" dir="rtl">
          {children}
        </main>
