    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03]"
          style={{ backgroundImage: "linear-gradient(hsl(40 65% 48%) 1px, transparent 1px), linear-gradient(90deg, hsl(40 65% 48%) 1px, transparent 1px)",
            backgroundSize: "40px 40px", animation: "gridMove 20s linear infinite" }} />
        {/* Top glow */}
        ...
        {/* Floating particles */}
        <div className="absolute w-3 h-3 rounded-full top-[20%] left-[15%]" style={{ background: "hsl(40 65% 48%)", opacity: 0.15, filter: "blur(1px)", animation: "float1 8s ease-in-out infinite" }} />
        <div className="absolute w-2 h-2 rounded-full top-[60%] right-[20%]" style={{ background: "hsl(40 65% 48%)", opacity: 0.12, filter: "blur(1px)", animation: "float2 10s ease-in-out infinite" }} />
        <div className="absolute w-2.5 h-2.5 rounded-full top-[35%] right-[10%]" style={{ background: "hsl(40 65% 48%)", opacity: 0.1, filter: "blur(1px)", animation: "float3 12s ease-in-out infinite" }} />
        <div className="absolute w-1.5 h-1.5 rounded-full top-[75%] left-[30%]" style={{ background: "hsl(40 65% 48%)", opacity: 0.18, filter: "blur(1px)", animation: "float2 7s ease-in-out infinite 1s" }} />
        <div className="absolute w-2 h-2 rounded-full top-[10%] right-[35%]" style={{ background: "hsl(40 65% 48%)", opacity: 0.08, filter: "blur(1px)", animation: "float1 9s ease-in-out infinite 2s" }} />
      </div>
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-5">
            <div className="absolute inset-0 rounded-2xl"
              style={{ background: "radial-gradient(circle, hsl(40 65% 48% / 0.3) 0%, transparent 70%)", filter: "blur(20px)", transform: "scale(1.3)", animation: "pulseGlow 4s ease-in-out infinite" }} />
            <img
