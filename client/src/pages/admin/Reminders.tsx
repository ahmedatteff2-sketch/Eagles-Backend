    ...
    <div className="p-3 sm:p-6 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          {
            label: "أقصر تكرار",
            value: reminders.length > 0 ? `${Math.min(...reminders.map((r) => r.intervalMinutes))} د` : "—",
            icon: "⏱️",
          },
        ].map((stat, i) => (
          <div
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "hsl(0 0% 40%)" }}>
            أضف أذكاراً ليتم تذكير المستخدمين بها بشكل دوري
          </p>
          <button
        ...
        <div className="space-y-3">
          {reminders.map((r) => (
            <div
              key={r.id}
              className="rounded-xl p-5 transition-all duration-200 group relative overflow-hidden"
              style={{
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = r.isActive ? "hsl(40 65% 48% / 0.35)" : "hsl(0 0% 18%)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = r.isActive ? "hsl(40 65% 48% / 0.15)" : "hsl(0 0% 10%)";
              }}
            >
              {r.isActive && (
                <div
                  ...
                  style={{
                    background: "linear-gradient(90deg, transparent, hsl(40 65% 48% / 0.4), transparent)",
                  }}
                />
              )}
              ...
              <div className="flex items-start gap-4">
                ...
                <div
                  ...
                  style={{
                    background: r.isActive
                      ? "linear-gradient(135deg, hsl(40 65% 48% / 0.15), hsl(40 65% 48% / 0.05))"
                      : "hsl(0 0% 8%)",
                ...
                <div className="flex-1 min-w-0">
                  <p
                    ...
                    style={{ color: r.isActive ? "hsl(0 0% 88%)" : "hsl(0 0% 50%)" }}
                  >
                    {r.content}
                  </p>
                  <div className="flex items-center gap-4 flex-wrap">
                    ...
                    >
                      <span
                        ...
                        style={{ background: r.isActive ? "hsl(142 60% 50%)" : "hsl(0 0% 30%)" }}
                      />
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  >
                    <div
                      className="absolute top-0.5 rounded-full transition-all duration-300 bg-white shadow-md"
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.background = "hsl(40 65% 48% / 0.1)";
                    }}
                    onMouseLeave={(e) => {
        ...
        >
          ...
          >
            ...
            <div
              className="absolute inset-x-0 top-0 h-px"
              style={{
                background: "linear-gradient(90deg, transparent, hsl(40 65% 48% / 0.8), transparent)",
              }}
            />
            ...
            <div className="px-6 pb-6 space-y-5">
              <div>
                ...
                <textarea
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.boxShadow = "0 0 0 3px hsl(40 65% 48% / 0.1)";
                  }}
                  onBlur={(e) => {
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, intervalMinutes: parseInt(e.target.value) || 1 })
                    }
                  ...
                  <div className="flex gap-1.5">
                    {[15, 30, 60].map((mins) => (
                      <button
                        ...
                        style={{
                          background:
                            formData.intervalMinutes === mins ? "hsl(40 65% 48% / 0.2)" : "hsl(0 0% 12%)",
              ...
              >
                <div>
                  <span className="text-sm font-semibold" style={{ color: "hsl(0 0% 75%)" }}>
                    تفعيل الذكر
                  </span>
                  <p className="text-xs mt-0.5" style={{ color: "hsl(0 0% 40%)" }}>
                    سيظهر للمستخدمين فور التفعيل
                  </p>
                </div>
                <button
