    ...
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: "1px solid hsl(0 0% 15%)" }}>
          <div className="flex items-center gap-2 px-5 py-3.5" style={{ background: "hsl(0 0% 9%)", borderBottom: "1px solid hsl(0 0% 13%)" }}>
            <span>🏆</span>
            <h2 className="text-sm font-semibold text-foreground">الأكثر نشاطاً هذا الأسبوع</h2>
          </div>
          <div style={{ background: "hsl(0 0% 8%)" }}>
            {topAttendees.length === 0 ? (
              <div className="px-5 py-8 text-center"><p className="text-xs text-muted-foreground">لا توجد بيانات</p></div>
            ) : (
                  ...
                  <div key={m.id ?? i} className="flex items-center justify-between px-5 py-2.5">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0"
                        style={{ background: i === 0 ? `${GOLD}30` : "hsl(0 0% 14%)", color: i === 0 ? GOLD : "hsl(0 0% 60%)" }}>
                        {i + 1}
                      </div>
                      <p className="text-sm text-foreground">{m.name}</p>
                    </div>
                    <span className="text-xs font-bold" style={{ color: GOLD }}>{m.checkins} حضور</span>
                  </div>
                ))}
              </div>
            )}
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: "1px solid hsl(0 0% 15%)" }}>
          ...
          <div style={{ background: "hsl(0 0% 8%)" }}>
            {inactiveMembers.length === 0 ? (
              <div className="px-5 py-8 text-center"><p className="text-xs text-muted-foreground">كل الأعضاء نشطين 💪</p></div>
            ) : (
              <div className="divide-y" style={{ borderColor: "hsl(0 0% 12%)" }}>
