...
export default function PersonalRecords() {
  ...
  logList.forEach((l: any) => {
    ...
    const r = l.reps ?? 0;
    if (!prMap[name])
      prMap[name] = { name, maxWeight: 0, maxReps: 0, estimated1RM: 0, date: "", totalSets: 0 };
          ...
          {records.map((pr, i) => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${i < 3 ? "hsl(40 65% 48% / 0.2)" : "hsl(0 0% 14%)"}`,
              }}
            >
              <div
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {pr.totalSets} مجموعة · 1RM: {pr.estimated1RM} كجم
                </p>
              </div>
